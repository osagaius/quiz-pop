...
ActiveRecord::Schema.define(version: 20150724025751) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.boolean  "player_1_challenge_completed", default: false
    t.boolean  "player_2_challenge_completed", default: false
  end
